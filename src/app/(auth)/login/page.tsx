      ...
      <div className="bg-[#111111] border border-white/8 rounded-2xl p-8 shadow-2xl">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex justify-end">
            <Link href="/reset-password" className="text-sm text-red-500 hover:text-red-400 transition-colors">
              Mot de passe oublié ?
            </Link>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-red-600 hover:bg-red-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-xl transition-all duration-200 shadow-lg shadow-red-600/30 hover:shadow-red-600/50 hover:-translate-y-0.5 text-sm"
          >
            {loading ? (
